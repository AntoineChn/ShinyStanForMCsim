...
<span style="color:red">T-M Message</span> : Le modèle doit être <span style="color:red">paramétrique</span> pour utiliser la méthode MCMC.
...
- Dans l'**apprentissage des paramètres** (avec l'approche Bayésienne), MCMC : méthode générale pour les simuler la distribution *a posteriori*. *e.g.*
...
- Autocorrelation faible
    - sinon, exploitation lonte d'espace des parametres
- Correlation faible
